...
<CaptionedImage
	src='/images/posts/fixing-blurry-pixel-fonts/FreePixel_example.webp'
	alt='FreePixel font example'
	caption='A sample of the FreePixel font.'
/>
...
<CaptionedImage
	src='/images/posts/fixing-blurry-pixel-fonts/blurry_crisp_comparison.webp'
	alt='A comparison of the blurry and crisp text'
	caption='Crisp (top) vs Blurry (bottom)'
/>
...
<CaptionedImage
	src='/images/posts/fixing-blurry-pixel-fonts/interpolation_small.webp'
	alt='A comparison of the blurry and crisp text'
	caption='My attempt at visualizing pixel interpolation. This is the letter "m" being translated 0.5px to the right.'
/>
